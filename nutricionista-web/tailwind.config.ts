...
module.exports = {
  ...
  safelist: [
    'bg-primary',
    // 'dark:bg-primary', // ELIMINADO
    'bg-primary-500',
    // 'dark:bg-primary-500', // ELIMINADO
    'text-primary',
    // 'dark:text-primary', // ELIMINADO
    'bg-white',
    'text-gray-900',
    // 'dark:bg-neutral-950', // ELIMINADO
    // 'dark:text-white', // ELIMINADO
    {
      pattern:
        // ELIMINADO 'dark:bg|dark:text' del patrón de REGEX 
  ...
  plugins: [],
  // darkMode: 'class', // ELIMINADO ESTA LÍNEA ENTERA
};