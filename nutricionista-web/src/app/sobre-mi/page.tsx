...
export default function SobreMiPage() {
  ...
  return (
    <main className="bg-white text-gray-900"> {/* Removed dark:bg-zinc-950 and dark:text-white */}
      {/* Hero */}
      <section className="text-center py-24 px-6 bg-gradient-to-br from-blue-100 to-purple-100 rounded-b-xl shadow-lg"> {/* Removed dark:from-zinc-800 and dark:to-zinc-900 */}
        <motion.h1
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7 }}
          className="text-4xl sm:text-5xl font-extrabold leading-tight text-gray-900" /* Removed dark:text-white */
        >
          Mucho gusto,<br />
        ...
        <motion.p
          ...
          className="mt-4 max-w-2xl mx-auto text-sm text-gray-700" /* Removed dark:text-gray-300 */
        >
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-blue-50 to-purple-50"> {/* Removed dark:from-zinc-800 and dark:to-zinc-900 */}
        <div className="max-w-6xl mx-auto grid gap-12 md:grid-cols-2 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl sm:text-5xl font-bold mb-6 text-gray-900">¿Quién soy?</h2> {/* Removed dark:text-white */}
            
            <p className="text-xs text-gray-600 mb-4"> {/* Removed dark:text-gray-300 */}
            ...
            <p className="text-xs text-gray-600"> {/* Removed dark:text-gray-300 */}
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-[#ffb4b9] to-[#ffcdb2] rounded-3xl shadow-xl mx-auto max-w-6xl"> {/* Removed dark:from-zinc-800 and dark:to-zinc-900 */}
      <div className="max-w-6xl mx-auto grid gap-12 md:grid-cols-2 items-center">
        ...
        <motion.div
          ...
          className="p-4"
        >
          <h2 className="text-4xl font-bold mb-6 text-gray-900"> {/* Removed dark:text-white */}
            ¿Cómo que un <span className="text-primary">Podcast</span>?
          </h2>
          <p className="text-base leading-relaxed text-gray-700"> {/* Removed dark:text-gray-300 */}
        ...
        >
          <motion.div
            ...
            transition={{ type: "spring", stiffness: 300, damping: 20 }}
            className="relative w-[300px] h-[300px] rounded-3xl overflow-hidden shadow-2xl border-4 border-primary/20 bg-gradient-to-br from-blue-100 to-purple-100" /* Removed dark:from-zinc-800 and dark:to-zinc-900 */
          >
            <Image
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-blue-50 to-purple-50"> {/* Removed dark:from-zinc-800 and dark:to-zinc-900 */}
        <div className="max-w-6xl mx-auto grid gap-12 md:grid-cols-2 items-center">
          ...
          >
            ...
            <p className="text-xs leading-relaxed text-gray-700"> {/* Removed dark:text-gray-300 */}
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-blue-50 to-purple-50"> {/* Removed dark:from-zinc-800 and dark:to-zinc-900 */}
        <div className="max-w-6xl mx-auto text-center">
          <motion.h2
            className="text-4xl font-bold mb-12 text-gray-900" /* Removed dark:text-white */
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
          ...
          <motion.p
            className="text-sm leading-relaxed text-gray-700 mb-10 max-w-3xl mx-auto" /* Removed dark:text-gray-300 */
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {blogPosts.map((post, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-6 bg-white border border-primary/20 rounded-xl shadow-xl flex flex-col justify-between transition-all duration-300 hover:shadow-2xl hover:border-primary" /* Removed dark:bg-zinc-900 */
                whileHover={{ y: -5 }}
              >
                <h3 className="text-lg font-semibold mb-3 text-gray-900 text-left">{post.title}</h3> {/* Removed dark:text-white */}
                <Link
                  href={post.href}
